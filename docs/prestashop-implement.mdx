...
In module configuration you can also disable Greenleaze for specific categories.
...
The greenleaze module provides a webhook to search for products from the Greenleaze Dashboard (see [webhooks](/docs/webhooks) for more informations).
The webhook link is :

```
https://your-shop.com/module/greenleaze/webhook?route=search-product&search
```

The webhook secret is your Greenleaze API key. The shop needs to be publicly accessible to receive the webhook.
